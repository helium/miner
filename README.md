...
This is for development purposes only and if you are interested in running a miner on Docker, please follow our guide [here](https://docs.helium.com/mine-hnt/build-a-packet-forwarder/#run-the-miner).
