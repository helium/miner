...
-ifndef('GATEWAY_REGION_PARAMS_STREAMED_RESP_V1_PB_PB_H').
-define('GATEWAY_REGION_PARAMS_STREAMED_RESP_V1_PB_PB_H', true).
-record(gateway_region_params_streamed_resp_v1_pb,
        {address = <<>>         :: iodata() | undefined, % = 1
         region = 'US915'       :: 'US915' | 'EU868' | 'EU433' | 'CN470' | 'CN779' | 'AU915' | 'AS923_1' | 'KR920' | 'IN865' | 'AS923_2' | 'AS923_3' | 'AS923_4' | integer() | undefined, % = 2, enum helium.region
         params = undefined     :: gateway_miner_client_pb:blockchain_region_params_v1_pb() | undefined % = 3
        }).
-endif.

-ifndef('GATEWAY_REGION_PARAMS_UPDATE_REQ_V1_PB_PB_H').
-define('GATEWAY_REGION_PARAMS_UPDATE_REQ_V1_PB_PB_H', true).
-record(gateway_region_params_update_req_v1_pb,
        {address = <<>>         :: iodata() | undefined, % = 1
