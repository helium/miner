...
startup(_Config) ->
    ...
    ?assertMatch({requesting, {data, undefined, _, _, _, _, _, _, _, _, _, _, _, _}}, sys:get_state(Statem)),
    ...
    ?assertMatch({requesting, {data, Chain, _, _, _, _, _, _, _, _, _, _, _, _}}, sys:get_state(Statem)),
    ok.
